...
// Sample sunglass brand data for investor analysis - Enhanced with VC-focused metrics
const sampleBrands: InsertBrand[] = [
  ...
  },
  {
    ...
    valuation: "100000000",
    businessModel: "d2c",
    distributionChannels: ["online", "social-media", "influencer-marketing"],
    competitiveAdvantage: "Strong social media presence, influencer partnerships, millennial appeal",
    technologyFocus: ["social-commerce", "influencer-platforms", "mobile-first"],
    sustainabilityScore: 68,
    brandPartnerships: ["Movado Group"],
    acquisitions: [
      { company: "Acquired by Movado", year: 2018, amount: "100M" }
    ],
    riskFactors: ["Trend dependency", "Social media algorithm changes"],
    opportunities: ["International expansion", "Product line extensions"]
  },
  {
    name: "Oliver Peoples",
    category: "luxury",
  ...
  },
  {
    ...
    description: "Celebrity-backed eyewear brand with charitable giving model",
    isPublic: false,
    locations: ["USA"],
    fundingStage: "series-a",
    totalFunding: "8000000",
    lastFundingDate: "2019-04-20",
    lastFundingAmount: "5000000",
    valuation: "50000000",
    investors: ["Celebrity investors", "Venture capital"],
    businessModel: "d2c",
    distributionChannels: ["online", "celebrity-partnerships", "social-media"],
    competitiveAdvantage: "Celebrity endorsements, charitable mission, trendy designs",
    technologyFocus: ["social-commerce", "influencer-marketing"],
    sustainabilityScore: 88,
    brandPartnerships: ["Various celebrities", "Charitable organizations"],
    riskFactors: ["Celebrity dependency", "Fashion trend risks"],
    opportunities: ["Celebrity line extensions", "International expansion", "Prescription market"]
  }];
    revenue: "350000000",
    growthRate: "15.8",
    marketShare: "3.2",
